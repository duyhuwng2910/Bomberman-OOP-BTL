...
public class Sprite {
    ...
    public static Sprite speed = new Sprite(16, 2, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite wallpass = new Sprite(16, 3, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite detonator = new Sprite(16, 4, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite bombpass = new Sprite(16, 5, 10, SpriteSheet.tiles, 16, 16);
    public static Sprite flamepass = new Sprite(16, 6, 10, SpriteSheet.tiles, 16, 16);
